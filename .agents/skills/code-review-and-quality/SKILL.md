...
description: Review a diff, branch, or pull request across correctness, readability,
  architecture, security, performance, and tests. Use for structured pre-merge review.
metadata:
