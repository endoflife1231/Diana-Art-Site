...
description: Build production-quality user interfaces with clear component boundaries,
  responsive layout, accessibility, state discipline, and visual verification.
metadata:
