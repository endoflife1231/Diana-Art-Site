...
metadata:
  ...
  source_path: skills/.curated/design-system/SKILL.md
---
...
```bash
Use `$ckm-slides` to create a 10-slide investor pitch for the project.
```
...
Review unsupported Claude skill fields manually: `argument-hint`, `author`, `license`, `metadata`, `version`.
