...
description: Harden code that handles untrusted input, authentication, authorization,
  secrets, storage, third-party services, or LLM tools. Use for secure-by-default
  implementation.
metadata:
